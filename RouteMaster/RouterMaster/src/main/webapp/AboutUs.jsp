...
<body>
    ...
    <main>
        <h1>About Us</h1>
        <h2>Welcome to RouteMaster - Your Ultimate Bus Ticket Reservation Platform!</h2>
        <h4>At RouteMaster, we're dedicated to simplifying your journey. We understand that travel should be a seamless and enjoyable experience, 
            and that's why we've created a platform that makes booking bus tickets as easy as a walk in the park.</h4>
    </main>
    <script>
