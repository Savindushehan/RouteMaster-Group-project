        ...
        <form action="insert" method="post">
            <div class="row1">
                <div class="colomn1">
                    ...
                    <span id="e1">Can't Empty</span>
                </div>
                <div class="colomn2">
                    <h2>Last Name</h2>
                    <input type="text" placeholder="LastNamer" id="lastname" name="lastname">
                    <span id="e2">Can't Empty</span>
                </div>
            </div>
            <div class="row2">
                <div class="colomn1">
                    ...
                    <span id="e3">Can't Empty</span>
                </div>
                <div class="colomn2">
                    <h2>Email</h2>
                    <input type="text" placeholder="Email" id="email" name="email">
                    <span id="e4">Can't Empty</span>
                </div>
            </div>
            <div class="row3">
                <div class="colomn1">
                    ...
                    <span id="e5">Can't Empty</span>
                </div>
                <div class="colomn2">
                    <h2>Password</h2>
                    <input type="text" placeholder="Password" id="password" name="password">
                    <span id="e6">Can't Empty</span>
                </div>
            </div>
            <button id="btn">Submt</button>
        </form>
    </main>
    <script>
